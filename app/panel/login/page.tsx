...
export default async function EditorialLoginPage() {
  ...
  return <main className="auth-page"><div className="auth-card editorial-auth-card">
    ...
    <p>Введіть погоджену електронну адресу, отримайте одноразовий шестизначний код у листі та підтвердьте вхід. Пароль залишається доступним як додатковий спосіб.</p>
