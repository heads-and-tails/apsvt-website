...
const sections: { kind: ContentKind; label: string; singular: string; description: string; publicHref: string; fields: Field[] }[] = [
  { kind: "lesson", label: "Розклад занять", singular: "заняття", description: "Пари, викладачі, групи та аудиторії", publicHref: "/schedule", fields: [
    ...
    { key: "group", label: "Курс / група", placeholder: "1 курс" }, { key: "faculty", label: "Факультет", options: ["Економіка і туризм", "Право"] }, { key: "teacher", label: "Викладач" }, { key: "room", label: "Аудиторія / формат", placeholder: "214 або Онлайн" },
    { key: "onlineLink", label: "Посилання на онлайн-заняття", placeholder: "https://meet.google.com/…", type: "url", required: false },
  ] },
  { kind: "exam", label: "Сесія", singular: "іспит або залік", description: "Дати сесії, контроль і місце проведення", publicHref: "/exam-schedule", fields: [
    ...
    { key: "form", label: "Форма", options: ["Іспит", "Залік", "Захист", "Консультація"] }, { key: "group", label: "Курс / група" }, { key: "faculty", label: "Факультет", options: ["Економіка і туризм", "Право"] }, { key: "teacher", label: "Викладач" }, { key: "room", label: "Місце", placeholder: "305 або Онлайн" },
    { key: "onlineLink", label: "Посилання на онлайн-іспит", placeholder: "https://teams.microsoft.com/…", type: "url", required: false },
  ] },
