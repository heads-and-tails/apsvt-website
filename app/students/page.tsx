...
export default function Page() { return <main id="top"><SiteHeader /><section className="phero img"><div className="bgi"><img src="/apsvt-students-real.jpg" alt="Студенти Академії" /></div><div className="wrap"><div className="crumb">Головна / Студенту</div><h1>Студентський<br />простір</h1><p className="lead">Навчання, розклад, кампус, можливості та підтримка — в одному зрозумілому маршруті.</p></div></section><div className="phero-rule" /><section id="services"><div className="wrap"><div className="sec-head"><div><div className="idx">01 / Сервіси</div><h2>Усе для навчання</h2></div></div><div className="icards service-grid">{services.map(([title, description, href]) => <Link className="icard" href={href} key={title}><b>{title}</b><span>{description}</span></Link>)}</div></div></section><section className="stats"><div className="wrap stat-grid"><div className="stat"><b>24/7</b><span>доступ до цифрових сервісів</span></div><div className="stat"><b>1</b><span>індивідуальна траєкторія</span></div><div className="stat"><b>9</b><span>освітніх напрямів</span></div><div className="stat"><b>3</b><span>кампусні маршрути</span></div></div></section><SiteFooter /></main> }
