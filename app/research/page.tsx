...
export default function Page(){return <main id="top"><SiteHeader />
  ...
  <PublicationSearch />
  <section className="stats"><div className="wrap stat-grid"><div className="stat"><b>200<i>+</i></b><span>праць у профілі Гліба Пріба</span></div><div className="stat"><b>8</b><span>профілів дослідників</span></div><div className="stat"><b>9</b><span>випусків Вісника в архіві</span></div><div className="stat"><b>30<i>+</i></b><span>років академічної науки</span></div></div></section>
  <SiteFooter /></main>}
