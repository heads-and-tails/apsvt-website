...
const specialties = [
  ...
  "D2 Фінанси й страхування",
  "D3 Менеджмент",
  "D4 Публічне управління",
  "D5 Маркетинг",
  "D7 Торгівля",
        ...
        <div className="wrap">
          <article className="journal-feature">
            ...
            <div>
              ...
              <p className="lead">
                У червні 2026 року серію «Економіка, психологія та управління»
                включено до Переліку наукових фахових видань України, категорія
                «Б».
              </p>
              <p>
                Видання продовжує академічну традицію, започатковану у 1998
                році, та публікує результати фундаментальних і прикладних
                досліджень.
              </p>
              <p>
