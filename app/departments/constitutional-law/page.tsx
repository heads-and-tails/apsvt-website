...
export default async function Page() {
  ...
  return <main id="top" className="criminal-department" data-page-materials-server="true"><SiteHeader />
    <section className="criminal-department-hero"><div className="wrap criminal-department-hero-grid">
      ...
      <figure className="criminal-department-hero-portrait"><img src={head?.image || "/people/law/tetiana-lebid.webp"} alt="Тетяна Лебідь, завідувачка кафедри" /><figcaption><small>Завідувачка кафедри</small><strong>{head?.name || "Тетяна Лебідь"}</strong><span>{head?.role || "доцентка"}</span></figcaption></figure>
