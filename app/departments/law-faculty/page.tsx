...
export default async function Page() {
  ...
  return <main id="top"><SiteHeader />
    ...
    <section className="law-practice-showcase"><div className="wrap"><div className="law-practice-head"><div><div className="idx">03 / Практика всередині факультету</div><h2>Навчальні ситуації,<br />наближені до реальних</h2></div><p>Студент проходить шлях від аналізу фактичної ситуації до аргументованої й етичної правової позиції.</p></div><div className="law-practice-grid"><Link href="/programs/law/legal-clinic"><span>01</span><small>Правова допомога</small><h3>Юридична клініка<br />«Феміда»</h3><p>Інтерв’ювання клієнта, правовий аналіз, підготовка відповіді й супервізія викладача.</p><b>Відкрити сторінку →</b></Link><Link href="/programs/law/forensic-laboratory"><span>02</span><small>Навчальна лабораторія</small><h3>Лабораторія<br />криміналістики</h3><p>Технічна фотолабораторія, кабінет слідчого, фіксація слідів і моделювання процесуальних дій.</p><b>Відкрити лабораторію →</b></Link><article><span>03</span><small>Професійне середовище</small><h3>Суди, адвокатура<br />та публічні установи</h3><p>Зовнішні бази практики кафедра підтверджує перед направленням відповідно до програми й навчального року.</p><b>За погодженням факультету</b></article></div></div></section>
