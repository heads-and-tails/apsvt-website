...
const departments = [
  ...
  ["02", "Кафедра публічного управління та публічної служби", "Публічна політика, служба, розвиток громад і соціальний діалог.", "/programs/public-administration"],
  ["03", "Кафедра цивільного, трудового та господарського права", "Цивільне, господарське, трудове право та судовий захист.", "/departments/private-law"],
