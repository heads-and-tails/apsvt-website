...
const facultyGroups = [
  ...
  },
  {
    ...
    departments: [
      { id: "law-faculty", title: "Кафедра конституційного, адміністративного та фінансового права", text: "Конституційний процес, публічна влада, адміністративне, фінансове та муніципальне право.", href: "/programs/law#department", programmes: "D8 Право" },
      ...
      { id: "public-administration", title: "Кафедра публічного управління та публічної служби", text: "Публічна політика, державна служба, громади та управління змінами.", href: "/programs/public-administration", programmes: "D4 Публічне управління" },
    ],
  },
  {
    code: "ЗАК",
