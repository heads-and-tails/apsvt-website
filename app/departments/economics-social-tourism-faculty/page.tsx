...
export default async function Page() {
  ...
  return <main id="top"><SiteHeader />
    ...
    <div id="department-news"><AcademicNews slugs={["finance", "management", "marketing", "trade", "professional-education", "tourism"]} title="Новини факультету й кафедр" /><DepartmentEditorialContent entries={departmentEntries} /></div>
    </SectionHub>
