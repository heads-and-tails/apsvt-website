...
export default async function Page() {
  ...
  return <main id="top" className="criminal-department"><SiteHeader />
    <section className="criminal-department-hero">
      <div className="wrap criminal-department-hero-grid">
        <div className="criminal-department-hero-copy">
          ...
          <h1>Кримінальне право,<br /><em>процес і криміналістика</em></h1>
    ...
    <section className="criminal-department-about"><div className="wrap criminal-department-about-grid">
      <div><div className="idx">01 / Про кафедру</div><h2>Три напрями.<br />Одна професійна логіка.</h2></div>
    ...
    <section className="criminal-department-research"><div className="wrap">
      <div className="sec-head"><div><div className="idx">02 / Наука</div><h2>Дослідження, що<br />відповідають практиці</h2></div><p>Кафедра досліджує протидію злочинності й корупції, кримінальну відповідальність у сфері трудового законодавства та сучасні виклики безпеці.</p></div>
