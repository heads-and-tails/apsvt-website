...
export default async function Page() {
  ...
  return <main id="top"><SiteHeader /><section className="phero"><div className="wrap"><div className="crumb">Головна / Студенту / Розклад</div><h1>Розклад<br />занять</h1><p className="lead">Один екран для пар, аудиторій і навчального тижня. Оберіть факультет, курс і день.</p><Link className="cta" href="/student-app"><span>Спробувати мобільне демо</span></Link></div></section><div className="phero-rule" /><section><div className="wrap"><div className="schedule-note"><span>Актуальний розклад</span><p>Розклад оновлюється редакцією Академії. Перед відвідуванням пари перевіряйте дату, аудиторію та можливі зміни.</p></div><ScheduleBrowser lessons={lessons} /></div></section><section className="soft" id="session"><div className="wrap"><div className="sec-head"><div><div className="idx">02 / Зимова сесія 2026/27</div><h2>Графік іспитів і заліків</h2></div><p>Оберіть факультет і курс. Дати й аудиторії оновлюються через редакційну панель.</p></div><ExamScheduleBrowser exams={exams} /></div></section><section><div className="wrap split"><div className="copy"><div className="idx">Навчальний рік</div><h2>Плануйте семестр цілісно</h2><p className="lead">Початок модулів, сесії, практика та канікули зібрані в окремому календарі.</p><Link className="cta dark" href="/academic-calendar"><span>Відкрити план року</span></Link></div><div className="panel"><h3>Як читати розклад</h3><ul><li><span className="y">01</span>Оновлення деканату має пріоритет</li><li><span className="y">02</span>Онлайн-пара позначається окремо</li><li><span className="y">03</span>Заміни з’являються у студентській платформі</li></ul></div></div></section><PageDocuments pagePath="/schedule" /><SiteFooter /></main>;
}
