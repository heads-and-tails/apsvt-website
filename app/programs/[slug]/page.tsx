...
export default async function Page({params}:{params:Promise<{slug:string}>}){
  ...
  return <main id="top"><SiteHeader />
    ...
    <section><div className="wrap"><div className="sec-head"><div><div className="idx">05 / Повна картина</div><h2>Усе важливе — на сторінці</h2></div></div><div className="program-completeness"><article><span>01</span><h3>Навчальний план</h3><p>Основні дисципліни розкладено за курсами вище.</p></article><article><span>02</span><h3>Вартість</h3><p>Денна, заочна та магістерська форми показані у блоці програми.</p></article><article><span>03</span><h3>Кар’єра</h3><p>Професії та сфери роботи сформовано за змістом програми.</p></article><article><span>04</span><h3>Міжнародне</h3><p>Доступні формати мобільності й партнерських програм зібрано окремо.</p></article></div></div></section>
    <SiteFooter /></main>;
}
