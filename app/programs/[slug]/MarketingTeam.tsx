...
export function MarketingTeam({ entries = [] }: { entries?: DepartmentEntry[] }) {
  ...
  return <section className="marketing-team-section" id="department-team"><div className="wrap">
    ...
    <div className="marketing-verbatim-grid">{team.map((member) => <article className="marketing-verbatim-card" key={member.name}>
      <div className="marketing-verbatim-overview">
        <div className="marketing-verbatim-photo"><img src={member.image} alt={member.name} loading="lazy" /></div>
