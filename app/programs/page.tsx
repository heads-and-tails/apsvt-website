...
export default function Page() {
  return <main id="top"><SiteHeader />
    ...
    <section className="soft research-resources"><div className="wrap">
      <div className="sec-head"><div><div className="idx">03 / Відновлені матеріали</div><h2>Документи освітніх програм</h2></div><p>Ключові положення й методичні матеріали, повернуті з файлового архіву попередньої версії сайту Академії.</p></div>
      ...
      <Link className="sec-link restored-all-link" href="/documents/archive">Усі відновлені документи →</Link>
    </div></section>
