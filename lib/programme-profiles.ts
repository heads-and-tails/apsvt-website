...
export const programmeProfiles: Record<string, ProgrammeProfile> = {
  ...
  "public-administration": {
    ...
    team: [
      { name: "Яна Качан", role: "завідувачка кафедри, кандидатка наук з державного управління, доцентка", summary: "Координує підготовку з публічного управління, дослідження трудових відносин і практичні проєкти для публічного сектору.", interests: ["публічна служба", "ринок праці", "лідерство"] },
      { name: "Віктор Сухомлин", role: "кандидат наук з державного управління, доцент", summary: "Поєднує академічне управління з дослідженнями державної політики та соціальної сфери.", interests: ["державне управління", "соціальна політика", "стратегія"], image: "/viktor-sukhomlyn.jpg", href: "https://scholar.google.com/citations?user=Fye2EVwAAAAJ&hl=en" },
      { name: "Ярослав Журавель", role: "доктор юридичних наук, професор", summary: "Досліджує децентралізацію, адміністративне право та реформування місцевого самоврядування.", interests: ["децентралізація", "муніципальне право", "адміністративне право"] },
    ],
    documents: [
