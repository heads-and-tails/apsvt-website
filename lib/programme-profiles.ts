...
export const programmeProfiles: Record<string, ProgrammeProfile> = {
  ...
  law: {
    ...
    team: [
      { name: "Ярослав Журавель", role: "декан, доктор юридичних наук, професор", summary: "Досліджує децентралізацію органів виконавчої влади, муніципальне й адміністративне право; автор численних правничих праць.", interests: ["адміністративне право", "децентралізація", "місцеве самоврядування"] },
      { name: "Ігор Діордіца", role: "доктор юридичних наук, професор", summary: "Поєднує викладання з дослідженнями інформаційного права, кібербезпеки та кримінально-правових механізмів захисту.", interests: ["інформаційне право", "кібербезпека", "кримінальне право"] },
      { name: "Василь Бонтлаб", role: "доктор юридичних наук, професор", summary: "Працює у сфері цивільного процесу, трудового права та захисту прав у приватно-правових відносинах.", interests: ["цивільний процес", "трудове право", "соціальний діалог"] },
    ],
    documents: [
