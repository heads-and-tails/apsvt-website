...
export const officialDocuments: OfficialDocument[] = [
  ...
  {
    id: "individual-study-plan-current",
    category: "education",
    title: "Положення про індивідуальний навчальний план здобувача",
    description: "Актуальний офіційний документ про формування, затвердження та виконання індивідуального навчального плану здобувача освіти.",
  ...
  {
    id: "unplanned-termination-educational-activity",
    category: "education",
    title: "Положення щодо порядку дій у разі позапланового припинення провадження освітньої діяльності",
    description: "Порядок захисту прав здобувачів і дій Академії у разі позапланового припинення освітньої діяльності.",
  ...
  {
    id: "student-practice-2020",
    category: "education",
    title: "Положення про практику здобувачів вищої освіти",
    description: "Організація, проведення, керівництво та підбиття підсумків практичної підготовки здобувачів Академії.",
  ...
  {
    id: "state-examination-commission",
    category: "education",
    title: "Положення про підготовку кваліфікаційних робіт та державну атестацію студентів",
    description: "Організація підготовки кваліфікаційних робіт, проведення державної атестації та оформлення її результатів.",
  ...
  {
    id: "academy-supervisory-board-regulation",
    category: "governance",
    title: "Положення про Наглядову раду Академії",
    description: "Офіційне положення про склад, повноваження та організацію роботи Наглядової ради Академії.",
    href: "/documents/academy/supervisory-board-regulation.pdf",
    format: "PDF",
    pages: 3,
    updated: "2011",
    status: "reference",
  ...
  {
    id: "academy-internal-rules",
    category: "governance",
    title: "Правила внутрішнього розпорядку Академії",
    description: "Права, обов’язки та правила організації внутрішнього розпорядку для працівників і здобувачів освіти.",
    href: "/documents/academy/internal-rules.pdf",
    format: "PDF",
    pages: 10,
    updated: "2013",
    status: "reference",
