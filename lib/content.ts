...
export const seedContent: ContentItem[] = [
  ...
  seed("thesis-demo-01", "student_thesis", {
    title: "Цифрові інструменти просування освітніх послуг",
    student: "Демонстраційний студент · бакалаврат",
    level: "Бакалавр",
    program: "Маркетинг",
    year: "2025",
  ...
  seed("thesis-demo-02", "student_thesis", {
    title: "Управління розвитком територіальної громади в умовах цифрової трансформації",
    student: "Демонстраційна студентка · магістратура",
    level: "Магістр",
    program: "Публічне управління та адміністрування",
    year: "2026",
    supervisor: "Науковий керівник · демонстраційний запис",
    abstract: "Приклад магістерського дослідження про цифрові сервіси громади, залучення мешканців до прийняття рішень та показники результативності місцевого управління.",
    keywords: "публічне управління, цифрова трансформація, громада",
    fileUrl: "",
    demo: "true",
  }, 20),
