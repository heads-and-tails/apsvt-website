...
export const editorialAccessOptions: EditorialAccessOption[] = [
  ...
  { value: "/departments/psychology-social-development-faculty/social-work", label: "Кафедра соціально-трудових відносин та соціальної роботи", group: "department" },
  ...
  { value: "/departments/constitutional-law", label: "Кафедра конституційного, адміністративного та фінансового права", group: "department" },
