...
const preapprovedDepartmentEditors = new Map<string, { displayName: string; accessScopes: string[] }>([
  ...
  ["blooming999jasmine@gmail.com", { displayName: "Редакторка кафедри фінансів", accessScopes: ["/programs/finance"] }],
  ["rts1@ukr.net", { displayName: "Ткаченко Яніна", accessScopes: ["/programs/finance"] }],
  ["glp2002@ukr.net", { displayName: "Редактор міжнародної діяльності та новин", accessScopes: ["/international", "/news"] }],
